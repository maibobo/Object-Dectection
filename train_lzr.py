...
#python train.py --logtostderr --pipeline_config_path=E:/shixi/ship_name/test/data/ssd_mobilenet_v1_coco.config --train_dir=E:/shixi/ship_name/test/train
#python train.py --logtostderr --pipeline_config_path=E:/shixi/ship_name/test/data/faster_rcnn_inception_v2_coco.config --train_dir=E:/shixi/ship_name/test/train