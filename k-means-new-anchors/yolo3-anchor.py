...
if __name__ == '__main__':
    ...
    input_annotation_txt_dir = '/home/workstation/darknet/VOCdevkit/VOC2019/labels'
    names = os.listdir(input_annotation_txt_dir)
    # 标注的框的宽和高
    annotations_w_h = []
    for name in names:
        txt_path = os.path.join(input_annotation_txt_dir, name)
        # 读取txt文件中的每一行
        f = open(txt_path, 'r')
    ...
    # 将anchor写入文件并保存
    output_anchors_txt = '/home/workstation/darknet/output_anchorsmcol-new3.29.txt'
    f_anchors = open(output_anchors_txt, 'w')
    #
    input_cfg_width = 608
    input_cfg_height = 608
